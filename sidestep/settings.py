...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-@4jzg#)e=2gndm+*x2uqriu6zcnd=&r7pztin)xvx3u0cxbk18')
...
WSGI_APPLICATION = 'sidestep.wsgi.application'
